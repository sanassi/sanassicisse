    ...
    <div id="projects">
      ...
      <div className="projects">
        <ProjectInfo
          ...
          lang={["C#", "TypeScript", "React", "Pgsql"]}
          description={["Collaborative Infinite Canvas App"]}
          link={{
            site: "other",
            url: "https://infinite-canvas.sanassicisse.workers.dev/",
          }}
        />
        <ProjectInfo
          name="Tiger Compiler Backend"
          lang={["C++"]}
          description={[
            "Compiler for the Tiger Language.",
            "14 weeks group project.",
          ]}
          link={{
            site: "other",
        ...
        <ProjectInfo
          ...
          description={[
            "Punto Board Game",
            "Multiplayer handled with Socket.IO (2 to 4 players)",
          ]}
          link={{
            site: "github",
